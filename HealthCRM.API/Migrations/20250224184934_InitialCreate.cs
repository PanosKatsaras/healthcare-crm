        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AMKA = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ΑΜΚΑ = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultPdf = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "90ad18e4-35dc-4385-8d56-249d72b3a3f2", "Admin", "ADMIN" },
                    { "2", "04028284-56d0-477e-bc4f-45f9d6980a4f", "Manager", "MANAGER" },
                    { "3", "30b4cf05-203b-41ba-a23f-a76259155da9", "Doctor", "DOCTOR" },
                    { "4", "2fc9769c-200e-46cd-bdf5-69e8d2a222a2", "Staff", "STAFF" }
                });
